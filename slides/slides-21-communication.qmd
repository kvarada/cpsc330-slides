...
- Check out [these final exam preparation guiding questions](https://ubc-cs.github.io/cpsc330-2025W1/lectures/notes/final-exam-review-guiding-question.html). 
...
Go to this Google doc: [https://tinyurl.com/5n8xf5yj](https://tinyurl.com/5n8xf5yj)

:::: {.columns}
:::{.column width="50%"}
Explanation 1: [https://tinyurl.com/msk2cfkb](https://tinyurl.com/msk2cfkb)
...
Explanation 2: [https://tinyurl.com/mt2z9ey5](https://tinyurl.com/mt2z9ey5)
...
**Result:** 
The manager doesn't know why this matters, how it affects decisions, or what to do next. No adoption. 😢
...
Key difference:
Shift from model-centric communication → decision-ready communication.
...
# ⚠️ Visualizing your data and results could be very powerful but at the same time can be misleading if not done properly. 
