---
title: "DSCI 571 Lecture 8: Linear models"
...
# [Class demo](https://github.ubc.ca/mds-2024-25/DSCI_571_sup-learn-1_students/tree/master/lectures/002-regressors-Varada-lectures/class_demos/demo_08_linear-models.ipynb)
...
https://canvas.ubc.ca/courses/147081/external_tools/53187
...
In this course, we have worked with various transformers and supervised machine learning models. The goal of this activity is collaboratively complete tables that provide an overview of 
...
(This will serve as a handy reference for your upcoming quiz and beyond!)

## Activity description {.smaller}

- Your task is to engage in group discussions and fill in the designated row in [this Google document](https://docs.google.com/document/d/1Ri601SbKs5fqHFP4lVnBlqGNOyJdYMJY-HoPp1B0jR0/edit?usp=sharing).
