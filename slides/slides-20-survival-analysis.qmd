...
- **Has the customer churned by the time of data collection?**
...
## The problem: Incomplete information {.smaller}
...
- **Left-censoring**: Event occurred before data collection started
...
## Approach 2: Assume everyone churns now ⛔️  {.smaller}
