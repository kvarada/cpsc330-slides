...
| Application | Answer |
|---|---|
| Google's spam detector 📧 | [✅]{.fragment} |
| Autocomplete on your phone 📱 | [✅]{.fragment} |
| Face recognition 🔓 | [✅]{.fragment} |
| Voice assistants 🎤 | [✅]{.fragment} |
| A basic calculator ➕ | [❌]{.fragment} |
| Netflix recommendations 🍿 | [✅]{.fragment} |
| A fixed-time alarm clock ⏰ | [❌]{.fragment} |
...
::: {.fragment}
**For either approach: what happens with a cat or fox we haven’t seen before?**
:::
...
- How confident are you? What else would you want to know?
...
![](img/therapists-using-ChatGPT.png){.nostretch fig-align="center" width="500px"}

## ❓❓ Rules, ML, or human judgment? {.smaller}

Use iClicker Cloud through Canvas. Choose a starting point for each problem and explain why. Combinations are possible.
