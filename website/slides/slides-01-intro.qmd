...
## Checklist for you before the next class {.smaller .slide-summary}
...
# Optional demos and activities {.appendix .slide-optional}

These examples extend the main lecture and can be explored as time permits.

## Example: Supervised classification {.smaller .slide-optional}
...
## Model predictions on new examples {.smaller .slide-optional}
...
## Text classification with a pretrained language model {.slide-optional}
\ 
...
## Zero-shot learning {.smaller .slide-optional}
\
...
## Zero-shot learning for emotion detection {.slide-optional}
\
...
## Zero-shot learning for emotion detection {.smaller .slide-optional}
\
...
## Optional: How the food clusters were computed {.slide-optional}
...
## Ways of learning from data {.slide-optional}
