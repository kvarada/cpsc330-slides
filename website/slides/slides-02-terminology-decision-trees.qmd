...
- Things due this week 
    - Homework 1 (hw1): Due Sept 14 11:59pm 
- Homework 2 (hw2) has been released (Due: Sept 21, 11:59pm)
- You can find the tentative due dates for all deliverables [here](https://ubc-cs.github.io/cpsc330-2026W1/#deliverable-due-dates-tentative).
...
iClicker join link: https://join.iclicker.com/GHJB
...
Clicker cloud join link: https://join.iclicker.com/GHJB
...
## iClicker 1.3: Classification vs. Regression {.smaller}

**iClicker cloud join link: https://join.iclicker.com/GHJB**
...
<img src="img/decision_tree_intuition.png" width="800">
...
**How do you feel about the concepts covered so far?**

- (A) So far so good  
- (B) I understand the high-level ideas but need to review details  
- (C) I'm feeling lost  
- (D) My brain is full; need a mini break  
- (E) Curious to see how this connects to what's next
...
## iClicker 1.4: Baselines and Decision trees {.smaller}
