...
- HW6 is due next week Monday
  - This one is computationally intensive — you’ll need to install several packages to get it running.
...
![](img/kmeans_boundaries.png){.nostretch fig-align="center" width="500px"}
...
3. If you have **≥ min_samples**, you are a **core point** $\rightarrow$ start spreading your colour.
